...
const SectionSkeleton = ({ height = "py-24" }: { height?: string }) => (
...
const Footer = dynamic(() => import('@/components/Footer'), {
    loading: () => <SectionSkeleton height="py-10" />,
});

const WHATSAPP_NUMBER = "573102353201";
const WHATSAPP_MSG = encodeURIComponent("Hola, me gustaría conocer más sobre los servicios de D2F Consulting.");
