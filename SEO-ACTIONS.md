# SEO — Acciones para posicionar "D2F" en Google (marca global)
...
2. Barra superior "Inspección de URLs" → pega y pide indexación de cada una:
   ...
   - `https://www.d2fgestion.com/blog/consultoria-empresarial-global`
   - `https://www.d2fgestion.com/blog/planeacion-estrategica-empresas-global`
3. Menú "Sitemaps" → confirma que `sitemap.xml` está "Correcto" (7 URLs).

---

## PASO 2 — Google Business Profile (EL más importante para "d2f")

Esto es lo que te pone en el mapa y en el panel de marca al buscar "d2f" en búsquedas relevantes.

1. https://business.google.com → busca "D2F Consulting"; reclama o crea.
2. Rellena con el NAP de arriba (idéntico).
3. **Descripción** (pegar):
```
D2F Consulting es una firma de consultoría empresarial y gestión estratégica con más de 20 años de experiencia. Ayudamos a empresas de todos los tamaños —pymes, startups y multinacionales— a crecer con estrategia, tecnología y resultados medibles.
...
• Desarrollo de Franquicias: expansión a nuevos mercados.
...
| Cámara de Comercio local | https://www.ccb.org.co | alta (si estás registrado, pide enlace en directorio) |
...
| Directorios regionales | varies | media |
| Cylex | https://www.cylex.com | media |
...
- "d2f consulting" / "d2f gestion": #1 alcanzable ~1–2 semanas tras
  indexación + GBP verificado. Es tu entidad exacta, sin competencia real.
- "d2f" a secas: término ambiguo a nivel mundial. Subirás lo más alto que permita tu
  autoridad + geolocalización del mercado. No hay garantía de #1 mundial en ese token.
